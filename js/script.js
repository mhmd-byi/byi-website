  ...
  THEMEMASCOT.isLTR = {
	...
	if ($('.work-carousel').length) {
		$('.work-carousel').owlCarousel({
			...
			navText: [
				'<span class="fa fa-long-arrow-alt-left"></span>', // Left arrow
				'<span class="fa fa-long-arrow-alt-right"></span>' // Right arrow
			],
			responsive: {
				0: {
					items: 1
	...
	$('.testimonial-carousel').owlCarousel({
		...
		navText: [
			'<span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-chevron-left fa-stack-1x fa-inverse"></i></span>',
			'<span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-chevron-right fa-stack-1x fa-inverse"></i></span>'
		],
	});
	});
